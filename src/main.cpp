      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Check the Lanes of other cars
            bool car_center = false;
            bool car_left = false;
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                ...
                if ( car_lane == lane ) {
                  car_center |= (check_car_s > car_s) && (check_car_s - car_s < 25);
                } else if ( car_lane - lane == -1  && car_left == false) {
                  car_left = (car_s - 10 < check_car_s) && (car_s + 25 > check_car_s);
                } else if ( car_lane - lane == 1 && car_right == false) {
                  car_right = car_s - 10 < check_car_s && car_s + 25 > check_car_s;
                }
            }
